  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold" style={{ color: '#FEEE00' }}>Hire Drivers</h2>
      </div>
      ...
      <div className="shadow rounded-lg" style={{ backgroundColor: '#232323' }}>
        <div className="border-b" style={{ borderColor: '#3a3a3a' }}>
          <nav className="flex space-x-8 px-6">
            <button
              ...
              style={activeSubTab.drivers === 'available' ? {
                borderColor: '#FEEE00',
                color: '#FEEE00'
              } : {
              ...
              onMouseEnter={(e) => {
                if (activeSubTab.drivers !== 'available') {
            ...
            <button
              ...
              className="py-4 px-1 border-b-2 font-medium text-sm transition-colors"
              style={activeSubTab.drivers === 'pending' ? {
                borderColor: '#FEEE00',
                color: '#FEEE00'
              } : {
                borderColor: 'transparent',
              ...
              onMouseEnter={(e) => {
                if (activeSubTab.drivers !== 'pending') {
                  e.currentTarget.style.color = '#FFFFFF';
                }
              }}
              onMouseLeave={(e) => {
            ...
            <button
              ...
              className="py-4 px-1 border-b-2 font-medium text-sm transition-colors"
              style={activeSubTab.drivers === 'hired' ? {
                borderColor: '#FEEE00',
                color: '#FEEE00'
              } : {
                borderColor: 'transparent',
        ...
        <div className="p-6">
          ...
          <div className="rounded-lg shadow-sm border p-4 mb-6" style={{ backgroundColor: '#1a1a1a', borderColor: '#3a3a3a' }}>
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0 lg:space-x-6">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2 border border-gray-600 rounded-md leading-5 bg-gray-800 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center space-x-4">
                <span className="text-sm font-medium text-white">Vehicle Class:</span>
                {['HMV', 'LMV', 'MCWG', 'MCWOG'].map(vehicleClass => (
                  <label key={vehicleClass} className="flex items-center">
                    ...
                    />
                    <span className="ml-2 text-sm text-white">{vehicleClass}</span>
                  </label>
                ))}
              </div>
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-gray-700 hover:bg-gray-200 rounded-md transition-colors"
              >
                Clear Filters
              </button>
            </div>
          ...
          {activeSubTab.drivers === 'available' && (
            <div>
              <h3 className="text-xl font-semibold text-yellow-500 mb-4">Available Drivers</h3>
              <div className="bg-gray-800">
                {driversLoading ? (
                  <div className="p-6 text-center">
                    <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
                    <p className="mt-2 text-gray-400">Loading drivers...</p>
                  </div>
                ) : drivers.length === 0 ? (
                  ...
                  return filteredDrivers.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div key={d._id || d.id} className="border rounded-lg shadow-sm bg-gray-800 hover:shadow-md transition-shadow">
                        <div className="p-5">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                <h3 className="text-lg font-semibold text-yellow-500">{d.name || 'Unnamed Driver'}</h3>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-6">
                              <div className="flex items-center space-x-4">
                                <span className="text-sm text-gray-400">DL: {d.dlNumber || 'N/A'}</span>
                        ...
                        {expandedDriver === (d._id || d.id) && (
                          <div className="border-t bg-gray-800 p-5">
                            {loadingDetails ? (
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-3">
                                  <div>
                                    ...
                                    <p className="text-sm text-yellow-500">{driverDetails[d._id || d.id].name || 'N/A'}</p>
                                  </div>
                                  <div>
                                    <label className="block text-sm font-medium text-white mb-1">DL Number</label>
                                    <p className="text-sm text-yellow-500">{driverDetails[d._id || d.id].dlNumber || 'N/A'}</p>
                                  </div>
                                  <div>
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-yellow-500">{driverDetails[d._id || d.id].bloodGroup || 'N/A'}</p>
                                  </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                  <div>
                                    ...
                                    <p className="text-sm text-yellow-500">{driverDetails[d._id || d.id].permanentAddress || 'N/A'}</p>
                                  </div>
                                  <div>
          ...
          {activeSubTab.drivers === 'pending' && (
            <div>
              <h3 className="text-xl font-semibold text-yellow-500 mb-4">Pending Job Offers</h3>
              <div className="bg-gray-800">
                {pendingOffersLoading ? (
                  <div className="p-6 text-center">
                    <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
                    <p className="mt-2 text-gray-400">Loading pending offers...</p>
                  </div>
                  ...
                  return filteredOffers.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div key={offer.id} className="border rounded-lg shadow-sm bg-gray-800 hover:shadow-md transition-shadow">
                        <div className="p-5">
                          <div className="flex items-center justify-between">
                            {/* Left Column - Icon and Name */}
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                <h3 className="text-lg font-semibold text-yellow-500">{offer.driver.name || 'Unnamed Driver'}</h3>
                            ...
                            <div className="flex items-center space-x-6">
                              <div className="flex items-center space-x-4">
                                <span className="text-sm text-gray-400">DL: {offer.driver.dlNumber || 'N/A'}</span>
                                <span className="text-sm text-gray-400">
                                  {Array.isArray(offer.driver.vehicleClass) ? offer.driver.vehicleClass.join(', ') : (offer.driver.vehicleClass || 'N/A')}
                                </span>
                                <span className="text-sm text-gray-400">Salary: ₹{offer.salaryPerDay}/day</span>
                              </div>
                            </div>
                          </div>
          ...
          {activeSubTab.drivers === 'hired' && (
            <div>
              <h3 className="text-xl font-semibold mb-4" style={{ color: '#FEEE00' }}>Hired Drivers</h3>
              <div style={{ backgroundColor: '#232323' }}>
                {hiredDriversLoading ? (
                  <div className="p-6 text-center">
                    <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
                    <p className="mt-2" style={{ color: '#888888' }}>Loading hired drivers...</p>
                  </div>
                ) : hiredDrivers.length === 0 ? (
                  <div className="text-center" style={{ color: '#888888' }}>You have not hired any drivers yet.</div>
                ) : (() => {
      ...
      {showOfferModal && selectedDriver && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-24 mx-auto p-5 border w-11/12 md:w-1/2 lg:w-1/3 shadow-lg rounded-md bg-gray-800">
            <div className="mt-3">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-yellow-500">Send Job Offer</h3>
                <button onClick={() => setShowOfferModal(false)} className="text-gray-400 hover:text-gray-400">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea rows={3} value={offerForm.message} onChange={(e) => setOfferForm(prev => ({ ...prev, message: e.target.value }))} className="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Write a short message to the driver" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-white mb-1">Salary / day (INR)</label>
                  <input type="number" min="0" value={offerForm.salaryPerDay} onChange={(e) => setOfferForm(prev => ({ ...prev, salaryPerDay: e.target.value }))} className="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="e.g., 1500" />
                </div>
              </div>
              <div className="flex justify-end gap-2 mt-6">
                <button onClick={() => setShowOfferModal(false)} className="px-4 py-2 text-sm font-medium text-white bg-gray-700 hover:bg-gray-200 rounded-md">Cancel</button>
